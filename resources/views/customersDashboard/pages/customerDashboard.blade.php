...
@section('content')
    ...
    <div class="custom-table">
        ...
        <div class="p-4 border-bottom d-flex justify-content-between align-items-center bg-white">
            ...
            <a href="{{ route('customers.orders') }}" class="btn btn-sm btn-outline-primary">View All</a>
        </div>
                    ...
                    @forelse ($orders as $order)
                        <tr>
                            ...
                            <td class="text-end pe-4">
                                <a class="btn btn-dark btn-sm" href="{{ route('customer.order.show', $order->order_list_id) }}">
                                    View Details
                                </a>
                            </td>
